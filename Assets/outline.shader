...
Shader "Outlined/UltimateOutline"
{
	Properties
	{
		...
		_FirstOutlineColor("Outline color", Color) = (0,0,0,0)
		_FirstOutlineWidth("Outlines width", Range(0.0, 2.0)) = 0.0

		_SecondOutlineColor("Outline color", Color) = (0.49, 0.86, 0.94,1)
